...
# foehn_fire_impact documentation build
...
from foehn_fire_impact import __version__ as release

# -- Project information -----------------------------------------------------

project = "foehn_fire_impact"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "foehn_fire_impactdoc"
...
latex_documents = [
    (
        master_doc,
        "foehn_fire_impact.tex",
        "foehn_fire_impact Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "foehn_fire_impact",
        "Project foehn_fire_impact codebase.",
        "Data-Science",
    )
]
