...
def make_rain_dataset(df_stations, params):
    ...
    # Obtain latitude and longitude coordinates from simulation grid, transform coordinate system, and build them into cKDTree for fast lookup of nearest neighbors
    ...
    # Ensure a continuous dataframe from 1981-2019 and merge dict values into it
